...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .badge.gift { background:#829ed6; color:#000; border:1px solid #829ed6; }
      ...
      <div class="details">
        ...
        <div class="info-grid">
          <?php if ($isFreeShippingGift): ?>
            <div class="info-card" style="display:flex; align-items:center; gap:8px; background:#829ed6; border-color:#829ed6; color:#fff;">
